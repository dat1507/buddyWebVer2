...
- **Free-plan gate:** current official limits are 500,000 Edge invocations/month, 150-second wall clock, 2-second CPU and 256 MB memory. A one-minute schedule is approximately 43,200 invocations in a 30-day month. There is no mandatory monthly worker fee while Supabase/Resend remain on Free plans and within quota; no paid upgrade is authorized.
