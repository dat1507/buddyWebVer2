...
**Next development task: FE-028 — Create own social-style profile view. Dependencies FE-025, BE-012, BE-014 and BE-015 are DONE; READY. AUTH-020 production acceptance remains pending operator-provided Redis/TLS/ingress configuration and does not block FE-028 development. Continue direct-to-main workflow; do not execute FE-028 unless explicitly requested.**
