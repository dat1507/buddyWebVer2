...
|---|---|---|
| **LOCAL** | **NOT READY (V2)** | `EMAIL-001`, `EMAIL-001A`, `MAIL-001`, `EMAIL-002`, `EMAIL-003` and `AUTH-V2-001` are complete; change-email UX, Redis Pub/Sub, realtime WebSocket and end-to-end flows remain absent. |
